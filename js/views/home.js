    ...
    <section class="block compact">
      <div class="container">
        ...
        <div class="home-tiles">
          ...
          <button class="home-tile tint-rose" data-add-tab="link"><img src="assets/icon-link.svg" alt="" /><span>Uit link</span></button>
        </div>
...
const SOURCE_META = {
  ...
  link:      { label: "Van link",     tint: "rose",     icon: '<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>' },
};
